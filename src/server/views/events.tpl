                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-9">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        <p class="card-text" style="font-size: 24px">6th of February | Yubileyny Sports Palace</p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-8">
                    ...
                    <div class="tab-pane fade show active" id="my" role="tabpanel" aria-labelledby="my-tab">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-9">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <svg class="ml-3" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <div class="row">
                            <div class="card mb-3 w-100">
                                <div class="row no-gutters">
                                    <div class="col-3">
                                        <img src="/img/foals.jpg" class="card-img img-fluid">
                                    </div>
                                    <div class="col-9">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <p class="card-text" style="font-size: 20px">29th of October | A2</p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <h1 class="card-title"><strong>The Foals</strong></h1>
                                                </div>
